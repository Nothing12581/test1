...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='训练LSTM Baseline模型')
    ...
    parser.add_argument('--save_dir', type=str, default='checkpoints/lstm_baseline',
                       help='模型保存目录')
...
def main():
    ...
    exp_name = f"lstm_baseline_{args.area}_{timestamp}"
    ...
    print("=" * 60)
    print(f"LSTM Baseline 模型训练 - {args.area}")
    print("=" * 60)
